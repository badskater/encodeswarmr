...
type Source struct {
	...
	// Thumbnails is an array of relative paths to preview thumbnail images.
	// Generated by the controller after analysis completes.
...
// UpdateSourceThumbnailsParams holds values for updating the thumbnails column.
type UpdateSourceThumbnailsParams struct {
	ID         string
	Thumbnails []string
}
